...
const WebgiViewer = forwardRef((props, ref) => {
  {
    ...
    const [previewMode, setPreviewMore] = useState(false);
    const [isMobile, setIsMobile] = useState(null);

    useImperativeHandle(ref, () => ({
      triggerPreview() {
        setPreviewMore(true);
        canvasContainerRef.current.style.pointerEvents =
          "all";
    ...
    const setupViewer = useCallback(async () => {
      ...
      if (isMobileOrTablet) {
        ...
        target.set(0, 1.37, 0);
        props.contentRef.current.className =
          "mobile-or-tablet";
      }
